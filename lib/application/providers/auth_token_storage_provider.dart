...
class AuthTokenStorageProvider extends StateNotifier<AuthStatus> {
  final String accessTokenKey = 'accessToken';
  final String refreshTokenKey = 'refreshToken';
  final FlutterSecureStorage _storage = const FlutterSecureStorage();

  AuthTokenStorageProvider() : super(AuthStatus.loading) {
    _checkAuthStatus();
  }
...
final authTokenStorageProvider =
    StateNotifierProvider<AuthTokenStorageProvider, AuthStatus>(
  (ref) => AuthTokenStorageProvider(),
);
